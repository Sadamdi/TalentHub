...
router.post('/register', [
  ...
  body('role').isIn(['talent', 'company']).withMessage('Role harus talent atau company'),
  body('location').optional().isString().withMessage('Lokasi harus berupa string'),
  body('phoneNumber').optional().isString().withMessage('Nomor telepon harus berupa string')
], async (req, res) => {
  try {
