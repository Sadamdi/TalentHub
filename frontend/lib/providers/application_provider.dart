...
class ApplicationProvider extends ChangeNotifier {
  ...
  Future<void> getCompanyApplications({bool silent = false}) async {
    print(
        '🔍 ApplicationProvider: Getting company applications... (silent: $silent)');
    if (!silent) {
      _setLoading(true);
    }
    _clearError();
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final previousCount = _companyApplications.length;
        ...
        print(
            '📈 ApplicationProvider: Previous count: $previousCount, New count: ${_companyApplications.length}');
